...
def create_block(
    ...
    **kwargs,
    ...
    # Set d_t - the temporal dimension should match the feature dimension for compatibility
    # Don't use num_patches as it's the spatial sequence length, not the temporal dimension
    if d_t is None:
        d_t = 24  # Use 24 as default for temporal dimension to match feature dimension at first layer
    # Remove debug print
    # print(f"DEBUG create_block: d_model={d_model}, num_patches={num_patches}, d_t={d_t}")
    if mamba_type == 'v1':
